import facebookIcon from '../../assets/photo/facebook.png'
import instagramIcon from '../../assets/photo/instagram.png'
import youtubeIcon from '../../assets/photo/youtube_icon.png'
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <aside>
                    ...
                    <p className='text-xl font-bold'>TeamBoard Software Industries Ltd.<br />Providing reliable tech since 1992</p>
                    <nav className="mt-5">
                        <h6 className="footer-title text-2xl">Social</h6>
                        <div className="grid grid-flow-col gap-4">

                            <a href="https://www.instagram.com/"><img className='w-10 h-10' src={instagramIcon} alt="" /></a>
                            <a href="https://www.youtube.com/"><img className='w-12 h-12' src={youtubeIcon} alt="" /></a>
                            <a href="https://www.facebook.com/"><img className='w-10 h-10' src={facebookIcon} alt="" /></a>
                        </div>
                    </nav>
                </aside>
                <nav>
